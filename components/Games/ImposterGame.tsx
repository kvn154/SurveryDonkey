      ...
      <div className="max-w-md mx-auto mt-20 p-8 bg-white rounded-xl shadow-2xl text-center border border-slate-100">
         ...
         {!showRole ? (
           <>
             ...
             <h1 className="text-4xl font-bold text-brand-600 mb-4">{player.name}</h1>
           ...
           <div className="animate-in zoom-in duration-300">
             ...
             {player.isImposter ? (
                <div className="bg-red-50 p-6 rounded-2xl border border-red-100 mb-6">
                   <h1 className="text-3xl font-bold text-red-600 mb-2 uppercase">Imposter</h1>
                ...
                <div className="bg-green-50 p-6 rounded-2xl border border-green-100 mb-6">
                   <h1 className="text-3xl font-bold text-green-600 mb-2 uppercase">Crewmate</h1>
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden border border-slate-200">
           ...
           <div className="bg-slate-900 text-white p-6 flex justify-between items-center">
              <div className="flex items-center gap-3">
                 <div className="w-10 h-10 rounded-full bg-brand-500 flex items-center justify-center font-bold text-xl text-brand-900">
                   {player.name[0]}
                 </div>
                 <div>
              ...
              {q.type === 'scale' && q.options ? (
                 ...
                 <div className="flex gap-2">
                    ...
                    <button 
                      ...
                      className="bg-brand-600 text-white px-6 rounded-xl hover:bg-brand-700 disabled:opacity-50 transition-colors"
                    >
                      <Send size={20} />
                    </button>
                 </div>
           ...
           <p className="text-center text-slate-400 mb-6 text-sm">Pass the device to {player.name}. Don't let others see your answer!</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="max-w-4xl mx-auto p-6 mt-6">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-8 mb-8">
           <h2 className="text-xl font-bold text-brand-800 mb-6 border-b border-slate-100 pb-4 italic">"{q.text}"</h2>
  ...
  if (phase === 'VOTING') {
    return (
      <div className="max-w-3xl mx-auto p-8 text-center mt-10">
         <h1 className="text-4xl font-bold text-red-600 mb-4 uppercase tracking-tighter italic">Emergency Meeting</h1>
